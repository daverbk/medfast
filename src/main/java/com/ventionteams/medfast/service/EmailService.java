...
public class EmailService {
    ...
    public void sendVerificationEmail(User user) throws MessagingException, IOException {
        ...
        context.setVariable("medfastMailbox", appProperties.getSpring().getMail().getUsername());//spring.mail.username
        ...
        helper.setFrom(appProperties.getSpring().getMail().getUsername());//spring.mail.username
