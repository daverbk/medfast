...
ALTER TABLE test_appointments
    ADD CONSTRAINT patients__fk FOREIGN KEY (patient_id) REFERENCES users (id) ON UPDATE RESTRICT ON DELETE RESTRICT;
-- rollback ALTER TABLE test_appointments DROP CONSTRAINT patients__fk;

-- changeset Katarzyna.Osowska:41_MED_146_Medical_Tests
ALTER TABLE test_appointments
    ADD CONSTRAINT doctors__fk FOREIGN KEY (doctor_id) REFERENCES users (id) ON UPDATE RESTRICT ON DELETE RESTRICT;
-- rollback ALTER TABLE test_appointments DROP CONSTRAINT doctors__fk;
